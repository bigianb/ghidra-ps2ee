...
import ghidra.app.util.bin.format.elf.extend.PS2EE_ElfExtension;
...
public class PS2EE_ElfRelocationHandler extends ElfRelocationHandler {
...
//	private static final String GOT_SYMBOL_NAME = "_GLOBAL_OFFSET_TABLE_";
		...
		if (elf.is64Bit()) {
			...
			for (int n = 0; n < 3; n++) {
				...
				doRelocate(mipsRelocationContext, relocType, symbolIndex, relocation,
					relocationAddress, nextRelocType != PS2EE_ElfRelocationConstants.R_MIPS_NONE ||
						saveValueForNextReloc);

				symbolIndex = 0; // set to STN_UNDEF(0) once symbol used by first relocation

				if (nextRelocType == PS2EE_ElfRelocationConstants.R_MIPS_NONE) {
					break;
				}
			}
		}
	...
	private void doRelocate(MIPS_ElfRelocationContext mipsRelocationContext, int relocType,
		...
		if (relocType == PS2EE_ElfRelocationConstants.R_MIPS_NONE) {
			return;
		}
		...
		if (!elfSymbol.isLocal()) {
			if (relocType == PS2EE_ElfRelocationConstants.R_MIPS_GOT_PAGE) {
				relocType = PS2EE_ElfRelocationConstants.R_MIPS_GOT_DISP;
				addend = 0; // addend handled by GOT_OFST
			}
			else if (relocType == PS2EE_ElfRelocationConstants.R_MICROMIPS_GOT_PAGE) {
				relocType = PS2EE_ElfRelocationConstants.R_MICROMIPS_GOT_DISP;
				addend = 0; // addend handled by GOT_OFST
			}
		}
		...
		switch (relocType) {
			...
			case PS2EE_ElfRelocationConstants.R_MIPS_GOT_OFST:
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_GOT_OFST:
			...
			case PS2EE_ElfRelocationConstants.R_MIPS_GOT_PAGE:
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_GOT_PAGE:
			...
			case PS2EE_ElfRelocationConstants.R_MIPS_GOT_DISP:
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_GOT_DISP:
			case PS2EE_ElfRelocationConstants.R_MIPS_GOT_HI16:
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_GOT_HI16:
				...
				int appliedValue;
				if (relocType == PS2EE_ElfRelocationConstants.R_MIPS_GOT_DISP) {
			...
			case PS2EE_ElfRelocationConstants.R_MIPS_GOT16:
			case PS2EE_ElfRelocationConstants.R_MIPS16_GOT16:
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_GOT16:
			...
			case PS2EE_ElfRelocationConstants.R_MIPS_CALL16:
			case PS2EE_ElfRelocationConstants.R_MIPS16_CALL16:
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_CALL16:
			...
			case PS2EE_ElfRelocationConstants.R_MIPS_CALL_HI16:
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_CALL_HI16:
			...
			case PS2EE_ElfRelocationConstants.R_MIPS_HI16:
			case PS2EE_ElfRelocationConstants.R_MIPS16_HI16:
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_HI16:
			...
			case PS2EE_ElfRelocationConstants.R_MIPS_LO16:
			case PS2EE_ElfRelocationConstants.R_MIPS16_LO16:
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_LO16:
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_HI0_LO16:
				...
				if (isGpDisp) {
					...
					if (relocType == PS2EE_ElfRelocationConstants.R_MIPS16_LO16) {
						value -= (offset & ~0x3);
					}
					else {
						value -= offset - 4;
			...
			case PS2EE_ElfRelocationConstants.R_MIPS_32:
				value = (int) symbolValue;
			...
			case PS2EE_ElfRelocationConstants.R_MIPS_REL32:
			...
			case PS2EE_ElfRelocationConstants.R_MIPS_26:
			case PS2EE_ElfRelocationConstants.R_MIPS16_26:
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_26_S1:
				int shift = (relocType == PS2EE_ElfRelocationConstants.R_MICROMIPS_26_S1) ? 1 : 2;
				if (mipsRelocationContext.extractAddend()) {
					addend = oldValue;
					addend &= PS2EE_ElfRelocationConstants.MIPS_LOW26;
					addend <<= shift;
				}
				...
				value &= PS2EE_ElfRelocationConstants.MIPS_LOW26;

				newValue = (oldValue & ~PS2EE_ElfRelocationConstants.MIPS_LOW26) | value;
				writeNewValue = true;
				break;

			case PS2EE_ElfRelocationConstants.R_MIPS_PC16:
				newValue =
			...
			case PS2EE_ElfRelocationConstants.R_MIPS_64:
				if (mipsRelocationContext.extractAddend()) {
			...
			case PS2EE_ElfRelocationConstants.R_MIPS_HIGHER:
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_HIGHER:
			...
			case PS2EE_ElfRelocationConstants.R_MIPS_HIGHEST:
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_HIGHEST:
				newValueBig = (mipsRelocationContext.extractAddend() ? oldValue : addend) & 0xffff;
...
//			case PS2EE_ElfRelocationConstants.R_MIPS_TLS_TPREL32:
//				if (mipsRelocationContext.extractAddend()) {
//					addend = oldValue;
//				}
...
//				break;
//
//			case PS2EE_ElfRelocationConstants.R_MIPS_TLS_TPREL64:
//				if (mipsRelocationContext.extractAddend()) {
//					addend = oldValue;
//				}
...
//				break;
//
//			case PS2EE_ElfRelocationConstants.R_MIPS_TLS_DTPREL32:
//				if (mipsRelocationContext.extractAddend()) {
//					addend = oldValue;
//				}
...
//
//
//			case PS2EE_ElfRelocationConstants.R_MIPS_TLS_DTPREL64:
//				if (mipsRelocationContext.extractAddend()) {
//					addend = oldValue;
//				}
...
//				break;
			...
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_PC7_S1:
				if (mipsRelocationContext.extractAddend()) {
			...
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_PC10_S1:
				if (mipsRelocationContext.extractAddend()) {
			...
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_PC16_S1:
				if (mipsRelocationContext.extractAddend()) {
			...
			case PS2EE_ElfRelocationConstants.R_MIPS_GPREL16:
			case PS2EE_ElfRelocationConstants.R_MIPS16_GPREL:
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_GPREL16:
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_GPREL7_S2:
			case PS2EE_ElfRelocationConstants.R_MIPS_LITERAL:
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_LITERAL:
				if (mipsRelocationContext.extractAddend()) {
					if (relocType == PS2EE_ElfRelocationConstants.R_MICROMIPS_GPREL7_S2) {
			...
			case PS2EE_ElfRelocationConstants.R_MIPS_SUB:
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_SUB:
				if (mipsRelocationContext.extractAddend()) {
					addend = oldValue;
				}
				newValueBig = symbolValue - addend;
			...
			case PS2EE_ElfRelocationConstants.R_MIPS_COPY:
			...
			case PS2EE_ElfRelocationConstants.R_MIPS_JUMP_SLOT:
				if (saveValue) {
			...
			case PS2EE_ElfRelocationConstants.R_MIPS_JALR:
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_JALR:
					...
					if (block != null) {
						if (MemoryBlock.EXTERNAL_BLOCK_NAME.equals(block.getName())) {
							...
							if (success) {
								...
								if (relocType == PS2EE_ElfRelocationConstants.R_MICROMIPS_JALR) {
				...
				if (!success) {
					markAsError(program, relocationAddress,
						relocType == PS2EE_ElfRelocationConstants.R_MIPS_JALR ? "R_MIPS_JALR"
								: "R_MICROMIPS_JALR",
	...
	private boolean isMIPS16Reloc(int type) {
		return type >= PS2EE_ElfRelocationConstants.R_MIPS16_LO &&
			type <= PS2EE_ElfRelocationConstants.R_MIPS16_HI;
	}

	private boolean isMicroMIPSReloc(int type) {
		return type >= PS2EE_ElfRelocationConstants.R_MICROMIPS_LO &&
			type <= PS2EE_ElfRelocationConstants.R_MICROMIPS_HI;
	}

	private boolean shuffleRequired(int type) {
		return isMIPS16Reloc(type) ||
			(isMicroMIPSReloc(type) && type != PS2EE_ElfRelocationConstants.R_MICROMIPS_PC7_S1 &&
				type != PS2EE_ElfRelocationConstants.R_MICROMIPS_PC10_S1);
	}

	private boolean isMIPS16_26_JAL_Reloc(int type, ElfRelocationContext elfRelocationContext) {
		return (type == PS2EE_ElfRelocationConstants.R_MIPS16_26 &&
	...
	private int unshuffle(int value, int type, ElfRelocationContext elfRelocationContext) {
		...
		else if (isMicroMIPSReloc(type) || type == PS2EE_ElfRelocationConstants.R_MIPS16_26) {
	...
	private boolean matchingHiLo16Types(int hi16Type, int lo16Type) {
		switch (hi16Type) {
			case PS2EE_ElfRelocationConstants.R_MIPS_HI16:
			case PS2EE_ElfRelocationConstants.R_MIPS_GOT16:
				return lo16Type == PS2EE_ElfRelocationConstants.R_MIPS_LO16;
			case PS2EE_ElfRelocationConstants.R_MIPS16_HI16:
			case PS2EE_ElfRelocationConstants.R_MIPS16_GOT16:
				return lo16Type == PS2EE_ElfRelocationConstants.R_MIPS16_LO16;
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_HI16:
			case PS2EE_ElfRelocationConstants.R_MICROMIPS_GOT16:
				return lo16Type == PS2EE_ElfRelocationConstants.R_MICROMIPS_LO16;
		}
		return false;
	}
	...
	private void processHI16Relocation(MIPS_ElfRelocationContext mipsRelocationContext,
		...
		if (hi16reloc.isGpDisp) {
			...
			if (hi16reloc.relocType == PS2EE_ElfRelocationConstants.R_MIPS16_HI16) {
...
// FIXME: should always use hi16reloc.addend - figure out at time of deferral
	...
	private static class MIPS_ElfRelocationContext extends ElfRelocationContext {
		...
		MIPS_ElfRelocationContext(PS2EE_ElfRelocationHandler handler, ElfLoadHelper loadHelper,
								  ElfRelocationTable relocationTable, Map<ElfSymbol, Address> symbolMap) {
		...
		boolean nextRelocationHasSameOffset(ElfRelocation relocation) {
			...
			return relocations[relocIndex].getOffset() == relocations[relocIndex + 1].getOffset() &&
				relocations[relocIndex + 1].getType() != PS2EE_ElfRelocationConstants.R_MIPS_NONE;
		}
		...
		long getAdjustedGPValue(/* reloc_object */) {
			...
			Symbol symbol = SymbolUtilities.getLabelOrFunctionSymbol(program,
				PS2EE_ElfExtension.MIPS_GP_VALUE_SYMBOL, err -> getLog().error("MIPS_ELF", err));
			if (symbol == null) {
				return -1;
			}
