...
import ghidra.app.util.bin.format.elf.relocation.PS2EE_Elf64Relocation;
...
public class PS2EE_ElfExtension extends ElfExtension {
	...
	public Class<? extends ElfRelocation> getRelocationClass(ElfHeader elfHeader) {
		if (elfHeader.is64Bit()) {
			return PS2EE_Elf64Relocation.class;
		}
